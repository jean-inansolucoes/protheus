...
User Function Recpaglat(lTerminal,cFilTerminal,cMatTerminal,cProcTerminal, nRecTipo, cPerTerminal, cSemanaTerminal)                 
...
conout("recpag**laticinio**0")
conout("recpag**laticinio**cFilTerminal="+cFilTerminal)
conout("recpag**laticinio**cMatTerminal="+cMatTerminal)
conout("recpag**laticinio**cProcTerminal="+cProcTerminal)
conout("recpag**laticinio**nRecTipo="+nRecTipo)
conout("recpag**laticinio**cPerTerminal="+cPerTerminal)
conout("recpag**laticinio**cSemanaTerminal="+cSemanaTerminal)
...
conout("recpag**laticinio**1")
conout("recpag**laticinio**cFilDe="+cFilDe)
conout("recpag**laticinio**cMatDe="+cMatDe)
...
IF nTipRel==3	
	...
	EndIF
Else	
	R030Imp(.F.,wnRel,cString,cMesAnoRef,lTerminal)	
EndIF
...
While SRA->( !Eof() .And. &cInicio <= cFim )
	...
	conout("recpag**laticinio**6")
	conout("recpag**laticinio**SRA->RA_FILIAL="+SRA->RA_FILIAL)
	conout("recpag**laticinio**SRA->RA_MAT="+SRA->RA_MAT)
	...
	ElseIf nTipRel == 2 .and. !( lTerminal )
		...
		ASize(ADesco,0)
		ASize(aBases,0)      	
	ElseIf (nTipRel == 4 .OR. nTipRel == 5) 
		conout("recpag**laticinio**10")
...
IF !( lTerminal ).And.cPaisLoc<>"PTG" 
	...
	If !Empty(aLog) .And. ApMsgNoYes(OemToAnsi(STR0208),OemToAnsi(STR0207)) //"Deseja imprimir o LOG das matrículas que não foram enviadas?"#"Atenção"
...
/*/{Protheus.doc} fImpressao
IMRESSAO DO RECIBO FORMULARIO CONTINUO  
@type Function
@author Zé Maria
@since 14/03/1995
@version Generic
...
/*/{Protheus.doc} fImpreZebr
IMRESSAO DO RECIBO FORMULARIO ZEBRADO 
@type Function
@author Zé Maria
@since 14/03/1995
@version Generic
...
/*/{Protheus.doc} fImpreGraf
IMRESSAO DO RECIBO FORMULARIO GRAFICO     
@type Function
@author Sservice
@since 05/05/2008
@version Generic
...
/*/{Protheus.doc} fCabec
Impressão Cabeçalho de Form Contínuo  
@type Function
@author Zé Maria
@since 14/03/1995
@version Generic
...
/*/{Protheus.doc} fCabecZ
Impressão Cabeçalho de Form Zebrado  
@type Function
@author Zé Maria
@since 14/03/1995
@version Generic
...
/*/{Protheus.doc} fCabecG
Impressão Cabeçalho Gráfico  
@type Function
@author SService
@since 04/05/2008
@version Generic
...
/*/{Protheus.doc} fCabecArg
Impressão Cabeçalho Argentina  
@type Function
...
/*/{Protheus.doc} fCabecZArg
Impressão Cabeçalho Argentina Zebrado 
@type Function
@author Microsiga
@since 02/12/03
@version AP6
...
/*/{Protheus.doc} fCabecZBol
Impressão Cabeçalho Bolivia
@type Function
@author Erika
@since 19/09/2008
@version AP6
...
/*/{Protheus.doc} fLanca
Impressao das Verbas (Lancamentos) Form. Continuo
@type Function
@author Ze Maria
@since 14/03/1995
@version Generic
...
/*/{Protheus.doc} fLancaZ
Impressao das Verbas (Lancamentos) Form. Zebrado
@type Function
@author Ze Maria
@since 14/03/1995
@version Generic
...
/*/{Protheus.doc} fLancaZBol
Impressao das Verbas (Lancamentos) Form. Zebrado - Bolívia
@type Function
@author Erika
@since 14/03/2008
@version Generic
...
Impressão da Continuação do Recibo
@type Function
@author Ze maria
@since 14/03/1995
@version Generic
...
/*/{Protheus.doc} fRodapeArg
Impressão do Rodapé - Argentina
@type Function
@author Silvia Taguti
@since 02/12/2003
@version AP6
...
/*/{Protheus.doc} CabHtmlArg
Retorna Cabecalho HTML para o RHOnLine - Argentina 
@type Function
...
/*/{Protheus.doc} CabHtmlBOL
Retorna Cabecalho HTML para o RHOnLine - BOLIVIA  
@type Function
@author Ricardo Berti
@since 10/01/2012
@version GPER030 
...
Retorna Rodape HTML para o RHOnLine   
@type Function
@author Ricardo Berti
@since 18/09/2013
@version GPER030 
...
/*/{Protheus.doc} fCabecPer
Impressao do Cabeçalho em Formulario Continuo Peru
@type Function
@author Alceu Pereira
@since 05/02/2010
@version Localizacao Peru 
/*/
...
/*/{Protheus.doc} fCabeczPer
Impressao do Cabeçalho em Formulario Zebrado Peru 
@type Function
@author Alceu Pereira
@since 08/02/2010
@version Localizacao Peru 
...
/*/{Protheus.doc} fRDescUbig
Exibir a descrição do Ubige contido na tabela auxiliar para Localização Peru
@type Function
@author Alceu Pereira
@since 09/02/2010
...
/*/{Protheus.doc} fRTipoEmp
Exibir a descrição do Tipo de Empregado contido na tabela S029 para Localização Peru
@type Function
@author Alceu Pereira
@since 15/07/2011
@version Generico Localizacao Peru 
...
/*/{Protheus.doc} fHorasFunc
Troca carecter da string passada como parametro 
@type Function
@author Alceu Pereira
@since 10/12/2010
@version GPER030
...
/*/{Protheus.doc} fCabPDF
Impressão do Cabeçalho em PDF
@type Function
@author Emerson Campos
@since 30/06/2015
@version Generic
...
/*/{Protheus.doc} fLancPDF
Impressão das Verbas (Lancamentos) PDF       
@type Function
@author Emerson Campos
@since 30/06/2015
@version Generic
...
Trazer o grupo de perguntas GPER030 quando houver schedule
@type Function
@author Emerson Campos
@since 30/06/2015
@version Generic
...
/*/{Protheus.doc} fCabecZDom
Impressão do Cabeçalho Form Zebrado
@type Function
