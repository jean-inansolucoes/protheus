...
±±³Programa  ³ LSFATR1  ³ Autor ³ Marco Bianchi         ³ Data ³ 07/07/06 ³±±
...
TRCell():New(oCabec,"C5_NUM"		,/*Tabela*/,STR0047					,PesqPict("SC5","C5_NUM")		,TamSx3("C5_NUM"		)[1]	,/*lPixel*/,{|| (cAliasSC5)->C5_NUM														})
TRCell():New(oCabec,"C5_CLIENTE"	,/*Tabela*/," "                     ,PesqPict("SC5","C5_CLIENTE")	,16								,/*lPixel*/,{|| IIF( (cAliasSC5)->C5_TIPO$"BD",STR0048,STR0049) + (cAliasSC5)->C5_CLIENTE	})
TRCell():New(oCabec,"C5_LOJA"		,/*Tabela*/,STR0050					,PesqPict("SC5","C5_LOJACLI")	,TamSx3("C5_LOJACLI"	)[1]	,/*lPixel*/,{|| (cAliasSC5)->C5_LOJACLI 													})
TRCell():New(oCabec,"CNOME"		    ,/*Tabela*/,RetTitle("A1_NOME")	    ,PesqPict("SA1","A1_NOME")		,TamSx3("A1_NOME"		)[1]	,/*lPixel*/,{|| IIF( (cAliasSC5)->C5_TIPO$"BD",SA2->A2_NOME,SA1->A1_NOME) 				})
TRCell():New(oCabec,"C5_EMISSAO"	,/*Tabela*/,STR0051					,PesqPict("SC5","C5_EMISSAO")	,nTamData    ,/*lPixel*/,{|| (cAliasSC5)->C5_EMISSAO},,,,,,.F.)
TRCell():New(oCabec,"C5_TRANS"	    ,/*Tabela*/,STR0052					,PesqPict("SC5","C5_TRANSP")	,TamSx3("C5_TRANSP"	)[1]        ,/*lPixel*/,{|| (cAliasSC5)->C5_TRANSP														})
TRCell():New(oCabec,"CVENDS"		,/*Tabela*/,STR0053					,PesqPict("SC5","C5_VEND1")	    ,34							    ,/*lPixel*/,{|| cVends																		})
TRCell():New(oCabec,"C5_CONDPAG"	,/*Tabela*/,STR0054					,PesqPict("SC5","C5_CONDPAG")	,TamSx3("C5_CONDPAG"	)[1]    ,/*lPixel*/,{|| (cAliasSC5)->C5_CONDPAG													})
...
TRCell():New(oPedaFat,"NQTDVEN"		,/*Tabela*/,STR0037					,"@E 999,999,999.99"/*PesqPict("SC6","C6_PRCVEN"		)*/,TamSx3("C6_PRCVEN"	)[1],/*lPixel*/,{|| nQtdVen 			},,,"RIGHT")	// "Vendido"
TRCell():New(oPedaFat,"NQTDENT"		,/*Tabela*/,STR0038					,"@E 999,999,999.99"/*PesqPict("SC6","C6_PRCVEN"		)*/,TamSx3("C6_PRCVEN"	)[1],/*lPixel*/,{|| nQtdEnt 			},,,"RIGHT")	// "Atendido"
TRCell():New(oPedaFat,"NSALDO"		,/*Tabela*/,STR0039					,"@E 999,999,999.99"/*PesqPict("SC6","C6_PRCVEN"		)*/,TamSx3("C6_PRCVEN"	)[1],/*lPixel*/,{|| nQtdVen-nQtdEnt		},,,"RIGHT")	// "Saldo"
TRCell():New(oPedaFat,"NQTLIB"		,/*Tabela*/,RetTitle("C6_QTDLIB")	,"@E 999,999,999.99"/*PesqPict("SC6","C6_PRCVEN"		)*/,TamSx3("C6_PRCVEN"	)[1],/*lPixel*/,{|| nQtLib				},,,"RIGHT")	// Quantidade Liberada
TRCell():New(oPedaFat,"NQTBLOQ"		,/*Tabela*/,STR0040					,"@E 999,999,999.99"/*PesqPict("SC6","C6_PRCVEN"		)*/,TamSx3("C6_PRCVEN"	)[1],/*lPixel*/,{|| nQtBloq				},,,"RIGHT")	// "Qtd.Bloqueada"
TRCell():New(oPedaFat,"NVALDESC"	,/*Tabela*/,RetTitle("C6_VALDESC")	,"@E 999,999,999.99"/*PesqPict("SC6","C6_VALDESC"	)*/,TamSx3("C6_VALDESC"	)[1],/*lPixel*/,{|| nValDesc			},,,"RIGHT")	// Valor do Desconto
TRCell():New(oPedaFat,"NPRCVEN"		,/*Tabela*/,RetTitle("C6_PRCVEN")	,"@E 999,999,999.99"/*PesqPict("SC6","C6_VALDESC"		)*/,TamSx3("C6_VALDESC"		)[1] ,/*lPixel*/,{|| nPrcVen				},,,"RIGHT")	// Preco Unitario
TRCell():New(oPedaFat,"CDESCTAB"	,/*Tabela*/,STR0059					,								 ,28						 ,/*lPixel*/,{|| cOP+"-"+cDescTab	})	// Situacao do Pedido
TRCell():New(oPedaFat,"NIMPLINHA"	,/*Tabela*/,STR0041					,"@E 999,999,999.99"/*PesqPict("SC6","C6_VALDESC"		)*/,TamSx3("C6_VALDESC"		)[1],/*lPixel*/ ,{|| nImpLinha			},,,"RIGHT")	// "Impostos"
TRCell():New(oPedaFat,"NTFAT"		,/*Tabela*/,STR0042					,"@E 999,999,999.99"/*PesqPict("SC6","C6_VALOR"		)*/,TamSx3("C6_VALOR"		)[1],/*lPixel*/ ,{|| nTFat				},,,"RIGHT")	// "Valor a Entregar"
...
While !oReport:Cancel() .AND. !( cAliasSC6 )->( Eof() ) .AND. (cAliasSC6)->C6_FILIAL == xFilial("SC6")
	...
	If mv_par06 == 3	//Todos os pedidos
		...
		//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
		If !Empty(cFilUsuSC5)
			SC5->(dbSeek(xFilial("SC5")+(cAliasSC6)->C6_NUM))
			If !SC5->(&cFilUsuSC5)
				(cAliasSC6)->(dbSkip())
				Loop
			Endif
		...
		//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
		If !Empty(cFilUsuSC6)
			SC6->(dbSeek(xFilial("SC6")+(cAliasSC6)->C6_NUM+(cAliasSC6)->C6_ITEM+(cAliasSC6)->C6_PRODUTO))
			If !SC6->(&cFilUsuSC6)
				(cAliasSC6)->(dbSkip())
				Loop
			Endif		
	...
	If lFiltro
		...
		If  cNumero + cItem + cProduto <> (cAliasSC6)->C6_NUM + (cAliasSC6)->C6_ITEM + (cAliasSC6)->C6_PRODUTO
			...
			If ( lContInt .AND. Len(aQuant)>0 .AND. mv_par06 <> 3 ) .OR. ( lContInt .AND. mv_par06 == 3 )
				...
				@li, 47 Psay TRANSFORM( nTotLocal, "@E 999,999,999.999" )
				@li, 62 Psay TRANSFORM( nQtdVen, "@E 999,999,999.999" )
				@li, 77 Psay TRANSFORM( nQtdEnt, "@E 999,999,999.999" )
				@li, 92 Psay TRANSFORM( (nQtdVen - nQtdEnt), "@E 999,999,999.999" )
				@li,107 Psay TRANSFORM( nQtLib, "@E 999,999,999.999" )
				@li,122 Psay TRANSFORM( nQtBloq, "@E 999,999,999.999" )
				//@li,137 Psay xMoeda(nValDesc,nC5Moeda,mv_par08,IIf(mv_par12 == 1,dC5Emissao,dDataBase)) PicTure tm(nValDesc,11)
				//@li,134 Psay xMoeda(nPrcVen ,nC5Moeda,mv_par08,IIf(mv_par12 == 1,dC5Emissao,dDataBase)) PicTure PesqPict((cAliasSC6),"C6_PRCVEN",15)
				@li,148 Psay Substr (cOp+"-"+cDescTab,1,24)
				If nImpLinha > 0
				   //	@li,174 Psay xMoeda(nImpLinha,nC5Moeda,mv_par08,IIf(MV_PAR12 == 1,dC5Emissao,dDataBase)) PicTure PesqPict((cAliasSC6),"C6_VALOR",15)
				EndIf
				If nTFat > 0
